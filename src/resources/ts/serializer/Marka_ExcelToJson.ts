...
const filePathToRead = path.resolve(__dirname, '../../data/catalogInfo/excels/marka_catalog.xlsx');
const filePathToWrite = path.resolve(__dirname, '../../data/catalogInfo/jsons/marka_catalog.json');
