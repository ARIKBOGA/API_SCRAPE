...
const filePathToRead = path.resolve(__dirname, '../resources/data/catalogInfo/excels/marka_catalog.xlsx');
const filePathToWrite = path.resolve(__dirname, '../resources/data/catalogInfo/jsons/marka_catalog.json');
