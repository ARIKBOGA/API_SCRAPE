...
const filePathToRead = path.resolve(__dirname, '../resources/data/catalogInfo/excels/model_new.xlsx');
const filePathToWrite = path.resolve(__dirname, '../resources/data/catalogInfo/jsons/model_new.json');
